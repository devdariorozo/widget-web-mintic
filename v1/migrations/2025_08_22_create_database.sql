...
-- *************************************************************************************************************************************************
-- *                                     REEMPLAZAR POR EL NOMBRE DE LA BASE DE DATOS
-- *************************************************************************************************************************************************


-- ? ELIMINAR LA BASE DE DATOS SI EXISTE
DROP DATABASE IF EXISTS `dbd_widget_chat_web_mintic`;



-- ? CREAR LA BASE DE DATOS
CREATE DATABASE `dbd_widget_chat_web_mintic`;


-- ? USAR LA BASE DE DATOS
USE `dbd_widget_chat_web_mintic`;
